  ...
  handlePayload(payload) {
    ...
    switch (payload) {
      ...
      case "MENTEEFORM_ELSE":
        ...
        case "MENTEEFORM_QUESTIONS_ONLINE":
        case "MENTEEFORM_QUESTIONS_LOCAL":
      ...
      case "MENTEEFORM_GENDER_MALE":
        ...
        case "MENTEEFORM_QUESTIONS":
            response = Response.genQuickReply(i18n.__("mentee_form.help1"), [
                {
                title: i18n.__("mentee_form.online"),
                payload: "MENTEEFORM_QUESTIONS_ONLINE"
                },
                {
                title: i18n.__("mentee_form.local"),
                payload: "MENTEEFORM_QUESTIONS_LOCAL"
                }
            ]);
            break;
